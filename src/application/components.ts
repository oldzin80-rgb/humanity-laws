...
function companionExtraCss(): string {
  return `.check-row{display:flex!important;grid-template-columns:auto 1fr;align-items:flex-start;gap:10px;font-weight:600!important;line-height:1.45}.check-row input{width:auto!important;margin-top:4px}.conversation-history{margin-top:18px;padding:18px;border:1px solid rgba(255,255,255,.1);border-radius:24px;background:rgba(0,0,0,.16)}.history-turn{border-top:1px solid rgba(255,255,255,.09);padding-top:12px;margin-top:12px}.history-turn strong{color:var(--gold)}.history-turn p{font-size:.95rem!important;margin:4px 0 10px!important;line-height:1.55!important}.response-next-steps{margin:14px 0;padding:14px;border:1px solid rgba(216,184,102,.24);border-radius:18px;background:rgba(216,184,102,.06)}.response-next-steps strong{color:var(--gold)}.response-next-steps ul{margin:8px 0 0;padding-left:20px;color:var(--soft);line-height:1.55}.avatar-presence{display:grid;grid-template-columns:minmax(0,1fr) minmax(220px,340px);gap:18px;align-items:center;margin:18px 0;padding:clamp(22px,4vw,38px);border:1px solid var(--line);border-radius:34px;background:linear-gradient(145deg,rgba(216,184,102,.08),rgba(255,255,255,.028));box-shadow:0 22px 70px rgba(0,0,0,.22)}.avatar-presence h2{font-size:clamp(1.6rem,3vw,2.7rem)}.avatar-presence small{display:block;color:var(--gray);line-height:1.5}.avatar-stage{display:flex;gap:12px;justify-content:flex-end;flex-wrap:wrap}.avatar-stage span{display:grid;place-items:center;min-width:116px;min-height:116px;border:1px solid rgba(216,184,102,.34);border-radius:999px;background:radial-gradient(circle at 35% 28%,rgba(255,255,255,.14),rgba(216,184,102,.08) 44%,rgba(0,0,0,.22));color:var(--soft);font-size:.84rem;text-align:center;padding:18px}@media(max-width:980px){.avatar-presence{grid-template-columns:1fr}.avatar-stage{justify-content:flex-start}}`;
}
