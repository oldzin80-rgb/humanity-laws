...
export function createAdamPage(): PageModel {
  ...
  return {
    ...
    sections: [
      ...
      { eyebrow: "Connected foundation", title: "Adam stays connected to the source.", body: `Adam uses the verified companion foundation, source ledger, and professional-boundary safeguards. Verified book sources visible: ${sourceReport.sources.length}.` },
